...
TAS_fusioncutter_heavyAug = 50;
TAS_fusioncutter_largeList = "[""3AS_MTT"",""3AS_ATT_Red"",""3AS_GAT""]";
TAS_fusioncutter_randomFail = 10;
TAS_fusioncutter_rateFast = 1;
TAS_fusioncutter_rateFull = 1;
TAS_fusioncutter_ratesplice = 1;
TAS_fusioncutter_timeDoor = "30";
TAS_fusioncutter_timeWreck = "180";
TAS_jetcoolset = 1;
TAS_jetfuelset = 1;
TAS_jetheatset = 1;
TAS_jetsoundvol = 0.6;
...
ace_advanced_ballistics_barrelLengthInfluenceEnabled = false;
ace_advanced_ballistics_bulletTraceEnabled = false;
ace_advanced_ballistics_enabled = false;
ace_advanced_ballistics_muzzleVelocityVariationEnabled = false;
ace_advanced_ballistics_simulationInterval = 0.2;
...
ace_cookoff_removeAmmoDuringCookoff = false;
...
acex_field_rations_hungerSatiated = 0.1;
acex_field_rations_nearDepletedConsequence = 1;
acex_field_rations_terrainObjectActions = false;
acex_field_rations_thirstQuenched = 0.1;
acex_field_rations_timeWithoutFood = 504;
acex_field_rations_timeWithoutWater = 168;
acex_field_rations_waterSourceActions = 2;

// ACE Fire
ace_fire_dropWeapon = 0;
ace_fire_enabled = true;
ace_fire_enableFlare = true;

// ACE Fortify
ace_fortify_markObjectsOnMap = 1;
ace_fortify_timeCostCoefficient = 0.75;
ace_fortify_timeMin = 0;
...
ace_hearing_explosionDeafnessCoefficient = 0;
...
ace_cargo_checkSizeInteraction = true;
...
ace_magazinerepack_timePerBeltLink = 4;
ace_magazinerepack_timePerMagazine = 1.5;
...
ace_medical_blood_maxBloodObjects = 50;
ace_medical_deathChance = 0.75;
...
ace_medical_gui_maxDistance = 5.02716;
...
ace_medical_treatment_litterCleanupDelay = 30;
...
ace_medical_treatment_maxLitterObjects = 50;
ace_medical_treatment_medicAdenosine = 1;
...
ace_medical_treatment_treatmentTimeAutoinjector = 2;
...
ace_nightvision_effectScaling = 0.45;
ace_nightvision_fogScaling = 0.6;
ace_nightvision_noiseScaling = 0.6;
ace_nightvision_shutterEffects = true;

// ACE Overheating
ace_overheating_cookoffCoef = 0;
ace_overheating_coolingCoef = 5;
ace_overheating_displayTextOnJam = false;
ace_overheating_enabled = false;
ace_overheating_heatCoef = 0;
ace_overheating_jamChanceCoef = 0;
...
ace_overheating_suppressorCoef = 0;
...
ace_gunbag_swapGunbagEnabled = false;
...
ace_parachute_failureChance = 0.01;
...
ace_weather_updateInterval = 300;
ace_weather_windSimulation = false;

// ACE Wind Deflection
ace_winddeflection_enabled = false;
ace_winddeflection_simulationInterval = 0.2;
...
diwako_dui_linecompass_enableOcclusion = true;
diwako_dui_linecompass_IconOutline = 1;
...
diwako_dui_enable_occlusion_cone = 270;
...
grad_trenches_functions_bigEnvelopeDigTime = 30;
...
grad_trenches_functions_createTrenchMarker = true;
grad_trenches_functions_decayTime = 300;
...
grad_trenches_functions_hitDecayMultiplier = 0.2;
grad_trenches_functions_LongEnvelopeDigTime = 60;
grad_trenches_functions_LongEnvelopeRemovalTime = -1;
grad_trenches_functions_playersInAreaRadius = 10;
...
grad_trenches_functions_smallEnvelopeDigTime = 20;
...
grad_trenches_functions_timeoutToDecay = 300;
...
WBK_HWF_WeapsArraySetting = "['MMG_01_hex_F', 'MMG_01_hex_ARCO_LP_F', 'MMG_01_tan_F', 'MMG_02_black_F', 'MMG_02_black_RCO_BI_F', 'MMG_02_sand_F', 'MMG_02_sand_RCO_LP_F', 'MMG_02_camo_F', 'OPTRE_M247H_Etilka', 'OPTRE_M247H_Shield_Etilka', 'JLTS_Z6', 'SWLW_Z6', 'IDA_Z6', 'HLC_wp_M134Painless', 'AR_Weapons_Rifles_z6']";
...
JLTS_settings_jumppack_customConsumption = false;
JLTS_settings_jumppack_customConsumptionCoef = 1;
JLTS_settings_jumppack_mainSwitch = 1;
JLTS_settings_jumppack_stances = 1;

// JLTS - Weapons
JLTS_settings_Common_dropShield = true;
JLTS_settings_EMP_EMPEffectScope = 2;
JLTS_settings_EMP_mainSwitch = 1;
...
JLTS_settings_Stun_mainSwitch = 1;
JLTS_settings_Stun_worksInVehicles = true;
...
kat_airway_probability_obstruction = 0;
kat_airway_probability_occluded = 0;
...
kat_breathing_enableCheckBreathing = false;
kat_breathing_Etco2_Enabled = false;
kat_breathing_Etco2_Units = 0;
kat_breathing_HPTXBleedAmount = 0.06;
kat_breathing_hptxChance = 0;
kat_breathing_inspectChest_enable = 0;
...
kat_breathing_PneumothoraxAlwaysVisible = true;
kat_breathing_PneumothoraxArrest = false;
kat_breathing_pneumothoraxChance = 0;
kat_breathing_pneumothoraxDamageThreshold = 0.4;
kat_breathing_pneumothoraxDamageThreshold_TakenDamage = false;
kat_breathing_PortableOxygenTank_RefillTime = 5;
kat_breathing_PulseOximeter_SpO2Warning = 85;
kat_breathing_severeValue = 66;
kat_breathing_showCyanosis = false;
...
kat_breathing_staminaLossAtLowSPO2 = false;
...
kat_circulation_AdvRhythm_canDeteriorate = false;
kat_circulation_AdvRhythm_CPR_ROSC_Chance = 10;
kat_circulation_AdvRhythm_deteriorateAfterTreatment = false;
...
kat_circulation_AED_X_VitalsMonitor_BloodPressureInterval = 1;
...
kat_circulation_bloodTypeCustomList = "O_N";
kat_circulation_bloodTypeRandomWeighted = false;
kat_circulation_bloodTypeSetting = 3;
kat_circulation_cardiacArrestBleedRate = 0.05;
kat_circulation_CPR_ChanceInterval = 10;
kat_circulation_CPR_MaxChance_Default = 59.9612;
kat_circulation_CPR_MaxChance_Doctor = 69.6509;
kat_circulation_CPR_MaxChance_RegularMedic = 70.1891;
kat_circulation_CPR_MinChance_Default = 29.8157;
kat_circulation_CPR_MinChance_Doctor = 39.5053;
kat_circulation_CPR_MinChance_RegularMedic = 40.0437;
...
kat_circulation_enable_selfBloodDraw = 0;
kat_circulation_hardcoreDiagnose = false;
kat_circulation_medLvl_AED = 0;
kat_circulation_medLvl_AED_Station_Interact = 1;
...
kat_hypothermia_hypothermiaActive = false;
...
kat_misc_allowSharedVehicleEquipment = 1;
kat_misc_enable = true;
kat_misc_enableStitchFullBody = true;
...
kat_pharma_coagulation_requireBV = 3;
...
kat_pharma_IVdropEnable = false;
kat_pharma_IVflowControl = false;
kat_pharma_IVreuse = true;
...
kat_pharma_medLvl_Amiodarone = 1;
kat_pharma_medLvl_ApplyIO = 1;
kat_pharma_medLvl_ApplyIV = 1;
kat_pharma_medLvl_Atropine = 1;
kat_pharma_medLvl_Caffeine = 1;
kat_pharma_medLvl_Carbonate = 1;
kat_pharma_medLvl_CWMP = 1;
kat_pharma_medLvl_EACA = 1;
kat_pharma_medLvl_EpinephrineIV = 1;
kat_pharma_medLvl_Etomidate = 1;
kat_pharma_medLvl_Fentanyl = 1;
kat_pharma_medLvl_Flumezenil = 1;
kat_pharma_medLvl_Ketamine = 1;
kat_pharma_medLvl_Lidocaine = 1;
kat_pharma_medLvl_Lorazepam = 1;
kat_pharma_medLvl_Nalbuphine = 1;
kat_pharma_medLvl_Naloxone = 1;
kat_pharma_medLvl_Nitroglycerin = 1;
kat_pharma_medLvl_Norepinephrine = 0;
kat_pharma_medLvl_Penthrox = 1;
kat_pharma_medLvl_Pervitin = 0;
kat_pharma_medLvl_Phenylephrine = 0;
kat_pharma_medLvl_Reorientation = 0;
kat_pharma_medLvl_TXA = 1;
kat_pharma_pervitinSpeed = 1.15;
kat_pharma_Reorientation_Enable = true;
kat_pharma_Reorientation_Slap = true;
kat_pharma_reorientationChance = 75;
...
kat_pharma_treatmentTime_CWMP = 3;
kat_pharma_treatmentTime_EACA = 7;
kat_pharma_treatmentTime_EpinephrineIV = 2;
...
ls_impulsor_overchargeDamageChance = 0.5;
ls_lighting_ai_enableFlashlights = true;
ls_vehicles_vivLoadingRange = 10;

// Lightsaber's And Force
IMS_ForceKillFriendlies = false;
...
OPTRE_Hijack_FriendlyFireEnabled = false;
OPTRE_Hijack_Mode = 0;
...
ScifiSupportPlus_DroidDispenser_customUnit = "[""ls_droid_b1"", ""ls_droid_b1_officer"", ""ls_droid_b1_heavy"", ""ls_droid_b1_at"", ""ls_droid_b1_grenadier""]";
ScifiSupportPlus_EXTERMINATUSHot = false;
ScifiSupportPlus_EXTERMINATUSVirus = true;
ScifiSupportPlus_FloodDropPod = true;
ScifiSupportPlus_FloodSporePod = true;
...
ScifiSupportPlus_OrbitalStrike = true;
...
ScifiSupportPlus_UNSC_HeavyInsertionPod_customUnit = "[""OPTRE_FC_Marines_Soldier_Rifleman_AT"", ""OPTRE_FC_Marines_Soldier_Rifleman_BR"", ""OPTRE_FC_Marines_Soldier_Rifleman_Light"", ""OPTRE_FC_Marines_Soldier_Rifleman_AR""]";
ScifiSupportPlus_UNSC_OrbitalVehicleDeployment = true;
ScifiSupportPlus_UNSC_SquadInsert = true;
ScifiSupportPlus_UNSC_SquadInsert_customUnit = "[""OPTRE_FC_Marines_Soldier_Rifleman_AT"", ""OPTRE_FC_Marines_Soldier_Rifleman_BR"", ""OPTRE_FC_Marines_Soldier_Rifleman_Light"", ""OPTRE_FC_Marines_Soldier_Rifleman_AR""]";
...
TFAR_setting_defaultFrequencies_lr_west = "50";
TFAR_setting_defaultFrequencies_sr_east = "";
TFAR_setting_defaultFrequencies_sr_independent = "";
TFAR_setting_defaultFrequencies_sr_west = "100, 101, 102, 103, 104, 105";
...
zen_faction_filter_0_JLTS_CIS = false;
...
zen_faction_filter_0_OPTRE_Zombies = true;
...
zen_faction_filter_1_JLTS_GAR = false;
