...
_object addAction [
	...
	}, nil, 1.5, false, false, "", QUOTE(!((_this getVariable [ARR_2('ace_medical_medicclass',0)]) > 0))
];
...
_object addAction [
	...
	}, nil, 1.5, false, false, "", QUOTE(!((_this getVariable [ARR_2('ace_isEngineer',0)]) > 0))
];
...
_object addAction [
	...
	}, nil, 1.5, false, false, "", QUOTE(!(_this getVariable [ARR_2('ace_isExplosiveSpecialist',false)]))
];
